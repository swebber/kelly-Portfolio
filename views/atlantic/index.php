<div class="atlantic portfolio-item">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-5">
            ...
            <p>As Crooks put it, "It needs to educate as well as entertain."</p>
            <p>“Liquid Assets” is about a maverick investor buying up water rights in the West, and talks about whether his plan could solve the region’s water crisis. To illustrate this article, I created an image that features the impact the water crisis has on farmers who choose to sell their land to the maverick investor for high profits, in effect, abandoning their town.</p>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-offset-1 col-md-10">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <img class="img-responsive" src="/content/img/atlantic/atlantic-003.jpg" />
                </div>
                <div class="col-sm-4">
                    <img class="img-responsive" src="/content/img/atlantic/atlantic-004.jpg" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-7">
            <img class="img-responsive" src="/content/img/atlantic/atlantic-005.jpg" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <a href="/typographic" class="btn btn-default">PREVIOUS</a>
            <a href="/atlantic" class="btn btn-default">BACK TO TOP</a>
            <a href="/trivalent" class="btn btn-default">NEXT</a>
        </div>
    </div>
